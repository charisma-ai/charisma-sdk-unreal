...
This Unreal Engine plugin is verified to work with C++ projects using engine version `4.26` and `5.0` only. If you find the plugin also works in another version, feel free to submit a pull request to update this!
